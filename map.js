...
mapboxgl.accessToken = 'pk.eyJ1IjoibGluYXNldCIsImEiOiJjbXA1dTdwNjQxZzluMnJwdjQ5Z3Uwa2FkIn0.15R2F4COG6kTu8KpflXiRw';
...
// decide style of bike lane
const bike_lane_style = {
    'line-color': '#32D400',
    'line-width': 3,
    'line-opacity': 0.6,
}
...
// color by traffic flow
let stationFlow = d3.scaleQuantize().domain([0, 1]).range([0, 0.5, 1]);

map.on('load', async () => {
    // -------------- add boston and cambridge route --------------
